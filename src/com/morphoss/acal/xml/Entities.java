 ...
 *   http://www.devdaily.com/java/jwarehouse/apps-for-android/Translate/src/com/beust/android/translate/Entities.java.shtml
 ...
 * 
 * @author <a href="mailto:alex@purpletech.com">Alexander Day Chaffee
 * @author <a href="mailto:ggregory@seagullsw.com">Gary Gregory
 * @since 2.0
 * @version $Id: Entities.java 636641 2008-03-13 06:11:30Z bayard $
 * 
 * @author <a href="mailto:andrew@morphoss.com">Andrew McMillan</a> Some minor changes to remove warnings. 
 */
class Entities {
    ...
    static class HashEntityMap extends MapIntMap {
        /**
         * Constructs a new instance of <code>HashEntityMap.
         */
    ...
    static class TreeEntityMap extends MapIntMap {
        /**
         * Constructs a new instance of <code>TreeEntityMap.
         */
    ...
    static class ArrayEntityMap implements EntityMap {
        ...
        /**
         * Constructs a new instance of <code>ArrayEntityMap.
         */
        ...
        /**
         * Constructs a new instance of <code>ArrayEntityMap specifying the size by which the array should
         * grow.
         * 
         * @param growBy
    ...
    static class BinaryEntityMap extends ArrayEntityMap {
        ...
        /**
         * Constructs a new instance of <code>BinaryEntityMap.
         */
        ...
        /**
         * Constructs a new instance of <code>ArrayEntityMap specifying the size by which the underlying array
         * should grow.
         * 
         * @param growBy
         *            array will be initialized to and will grow by this amount
    ...
    /**
     * <p>
     * Escapes the characters in a <code>String.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Escapes the characters in the <code>String passed and writes the result to the Writer
     * passed.
     * </p>
     * 
     * @param writer
     *            The <code>Writer to write the results of the escaping to. Assumed to be a non-null value.
     * @param str
     *            The <code>String to escape. Assumed to be a non-null value.
     * @throws IOException
     *             when <code>Writer passed throws the exception from calls to the {@link Writer#write(int)}
     *             methods.
     * 
     * @see #escape(String)
     * @see Writer
    ...
    /**
     * <p>
     * Unescapes the entities in a <code>String.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Unescapes the escaped entities in the <code>String passed and writes the result to the
     * <code>Writer passed.
     * </p>
     * 
     * @param writer
     *            The <code>Writer to write the results to; assumed to be non-null.
     * @param str
     *            The source <code>String to unescape; assumed to be non-null.
     * @throws IOException
     *             when <code>Writer passed throws the exception from calls to the {@link Writer#write(int)}
     *             methods.
     * 
     ...
     *            The source <code>String to unescape; assumed to be non-null.
     * @param firstAmp
     *            The <code>int index of the first ampersand in the source String.
     * @throws IOException
     *             when <code>Writer passed throws the exception from calls to the {@link Writer#write(int)}
     *             methods.
     */
